...
curl -u admin:admin -H "Content-Type: application/json" -d "{\"userId\":\"1\",\"name\":\"John Doe\", \"email\": \"john.doe@alfresco.com\", \"phone\":\"123456789\"}" http://localhost:8080/start-test
curl http://localhost:8080/runtime/process-instances
curl http://localhost:8080/runtime/signals